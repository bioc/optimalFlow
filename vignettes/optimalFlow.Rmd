...
bibliography: bibliography_cytometries.bib
vignette: >
...
```
A three dimensional plot as a static image follows. ![cosa](template_pooling.png)
...
```
With the respective 3d static image. ![Figure 2: normal database](database_normal.png)
